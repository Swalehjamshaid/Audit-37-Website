# tasks.py (FINAL CORRECTED CODE)

import json
from weasyprint import HTML, CSS
from flask import render_template
from flask_mail import Message
# Import the 'app' instance directly for explicit context
from app import app, db, mail, AuditService, User, AuditReport


def send_scheduled_report(user_id, url, recipient_email):
    # Use the imported 'app' instance to ensure context is correctly pushed
    with app.app_context(): 
        ...
        # Define content generation helper for use here (must be defined or imported)
